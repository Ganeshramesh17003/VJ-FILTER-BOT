...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002422331156')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Ganeshvjcollection')
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URL', "") # Necessary If clone mode is true
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/forcesubchannel170')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/forcesubchannel170')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '@jirayamaster_24') # Support Chat Link Without https:// or @
